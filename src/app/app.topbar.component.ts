...
import { Masterdowload } from './class/masterdowload';
			...
			<div class="layout-topbar-wrapper">
                <div class="layout-topbar-left">
					<div class="layout-topbar-logo-wrapper">
						<a href="/core/new" class="layout-topbar-logo">
							<img src="assets/empresas/satelital/logo/logo-empresa-login.png" alt="mirage-layout" />
							<span class="app-name">Satelital</span>
						</a>
					</div>
...
//#endregionSuscription Maestro
    constructor(public appMain: AppMainComponent,
		private router: Router,
		private coreObservable: CoreObservableService,

		) {
			this.coreObservableSubscription = this.coreObservable.masterdownload$
