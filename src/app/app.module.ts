...
import { NewServiceModule } from './components/modulo-servicio/new-service/new-service.module';
...
import { InformacionMapaModule } from './directives/informacion/informacion-mapa/informacion-mapa.module';
import { ListModule } from './components/modulo-servicio/list/list.module';
...
import { ReportServiceModule } from './components/report/report-service/report-service/report-service.module';
import { ReportServiceCardComponent } from './components/report/report-service-card/report-service-card.component';
import { FormComponent } from './components/form/form.component';
import { CompanyFormComponent } from './components/form/company-form/company-form.component';

export const MQTT_SERVICE_OPTIONS: IMqttServiceOptions = {
    url: environment.CONFIGURATION.WEB_SOCKET_RABBIT.URL, 
    username: environment.CONFIGURATION.WEB_SOCKET_RABBIT.USER, 
    password: environment.CONFIGURATION.WEB_SOCKET_RABBIT.PASSWORD 
  }
...
@NgModule({
    imports: [
        ...
        NgSelectModule ,         
        NewServiceModule,
        // ModalCancelReasonsModule
    ],
    declarations: [
        ModalCancelReasonsComponent,
        AppComponent,
        AppMainComponent,
        AppMenuComponent,
    ...
    providers: [
        ...
        PhotoService, ProductService, MenuService, BreadcrumbService, ConfigService,AuthenticationResolve,MaestrosResolve
    ],
