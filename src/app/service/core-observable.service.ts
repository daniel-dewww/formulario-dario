...
// import { AddCompanyService } from 'src/app/components/mantenedor/company/add-company/add-company.service';
...
export class CoreObservableService {
  ...
  masterdownload$ = this._masterdownload.asObservable();fnValidateViewExist
  public _company: BehaviorSubject<Company> = new BehaviorSubject<Company>(new Company());
